            ...
            <div className="p-6">
              <div className="relative mb-4">
                ...
                <input
                  ...
                  placeholder="Search by name, email, rollnumber..."
                        ...
                        <div className="relative w-12 h-12 flex-shrink-0">
                          <div className="w-12 h-12 rounded-full bg-gradient-to-br from-amber-500 to-yellow-500 flex items-center justify-center text-white font-bold shadow-md">
                            {searchUser.profilePicture ? (
                              <img src={searchUser.profilePicture} alt={searchUser.name} className="w-12 h-12 rounded-full object-cover select-none" draggable="false" />
                            ) : (
            ...
            <div className="p-5 border-b border-amber-100/50 bg-transparent">
              <div className="flex space-x-1 border-b border-amber-100/50">
                <button
                  ...
                  className={`flex-1 py-2 text-center text-sm font-medium transition-colors relative ${activeTab === 'chats'
                    ? 'text-gray-900'
                ...
                <button
                  ...
                  className={`flex-1 py-2 text-center text-sm font-medium transition-colors relative ${activeTab === 'requests'
                    ? 'text-gray-900'
                    : 'text-gray-500 hover:text-gray-700'
                    }`}
                >
                    ...
                    {chats.map((chat) => {
                      ...
                      return (
                        <div
                          ...
                          className={`p-4 rounded-xl cursor-pointer transition-all ${selectedChat?._id === chat._id
                          ...
                          <div className="flex items-start space-x-3">
                            <div className="relative flex-shrink-0">
                              <div className={`w-10 h-10 rounded-full ${selectedChat?._id === chat._id ? 'ring-2 ring-white' : ''} flex items-center justify-center text-white font-bold shadow-md`}>
                                {otherUser?.profilePicture ? (
                                  <img src={otherUser.profilePicture} alt={otherUser.name} className="w-10 h-10 rounded-full object-cover select-none" draggable="false" />
                                ) : (
                            ...
                            <div className="flex-1 min-w-0">
                              ...
                              <div className="flex items-center justify-between gap-2">
                                ...
                                {unreadCount > 0 && (
                                  <span className={`ml-2 text-xs font-bold rounded-full px-2.5 py-1 min-w-[24px] text-center flex-shrink-0 ${selectedChat?._id === chat._id
                    ...
                    {messageRequests.map((request) => {
                      ...
                      return (
                        <div
                          ...
                          className={`p-4 rounded-xl cursor-pointer transition-all ${selectedChat?._id === request._id
                      ...
                      <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-full bg-gradient-to-br from-amber-500 to-yellow-500 flex items-center justify-center text-white font-bold shadow-lg border-2 border-white">
                        {newChatUser.profilePicture ? (
                          <img
                            ...
                            className="w-10 h-10 sm:w-12 sm:h-12 rounded-full object-cover border-2 border-white shadow-md select-none"
                            draggable="false"
                          />
                        ) : (
                        ...
                        <div key={msg._id ? `msg-${msg._id}` : `msg-${selectedChat._id}-${index}`} className={messageSpacing}>
                          ...
                          <div className={`flex ${isOwn ? 'justify-end' : 'justify-start'} items-end gap-2`}>
                              ...
                              <div className="flex-shrink-0 w-8 h-8 sm:w-9 sm:h-9">
                                {getOtherUser(selectedChat)?.profilePicture ? (
                                  <img
                                    src={getOtherUser(selectedChat).profilePicture}
                                    alt={getOtherUser(selectedChat)?.name}
                                    className="w-full h-full rounded-full object-cover border-2 border-amber-200 select-none"
                                    draggable="false"
                                  />
                                ) : (
                            ...
                            <div className={`group relative max-w-[75%] sm:max-w-xs md:max-w-sm lg:max-w-md ${isOwn ? 'ml-auto' : ''} overflow-x-hidden`}>
                              <div
                                className={`px-3 sm:px-4 py-2 sm:py-2.5 rounded-2xl ${msg.isDeleted
